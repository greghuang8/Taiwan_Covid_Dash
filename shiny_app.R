...
daily_change <- read.csv("daily_changes/Daily_change_June_17.csv", 
...
daily_change_tw %>%
  ...
  labs(title = "臺灣新冠肺炎死亡案例統計",
       subtitle = "2021年6月17日更新 / 5月21日開始追蹤",
...
daily_change %>%
  ...
  labs(title = "Taiwan COVID Deaths",
       subtitle = "Updated June 17th, 2021 / Tracking began on May 21st, 2021",
